...
目前保留原本的 Next.js、Prisma、會員、郵件與後台架構，並以每日信訂閱作為主要每日發送方式。
...
See `DEPLOYMENT.md` for cron, daily mail, and database notes. See `PRODUCTION_CHECKLIST.md` for the fastest path to copy the working English Daily Sentence deployment pattern into a separate iPAS AI Daily production setup.
